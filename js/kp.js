/* kakao-pixel-web@1.6.1-release 2024-07-08 14:06:06 */
!(function () {
  try {
      ...
      var e = (function (e) {
          ...
          u = function () {
            ...
            return function (t) {
              if (
                ...
                throw Error("Weakmap-shim: Key must be object");
              var n = t.valueOf(e);
          ...
          m = (function () {
            ...
            function n(e) {
              ...
              !(function (e, t) {
                ...
                v(this, h, { writable: !0, value: void 0 }),
                v(this, y, { writable: !0, value: void 0 }),
                v(this, b, { writable: !0, value: void 0 }),
                d(this, h, t),
                d(this, y, r),
                d(this, b, o);
            }
            ...
            return (
              (e = [
                ...
                },
                {
                  ...
                  value: function (e) {
                    return (
                      this.storage.setItem(k.encryptedKakaoAccountId, e), this
                    );
                  },
                },
                {
          ...
          return (
            (e = [
              ...
              },
              {
                ...
                value: function (e) {
                  var t;
                  return null !== (t = this.storedItems[e]) && void 0 !== t
                    ? t
                    : null;
                },
              },
        ...
        T.exports = (function () {
          ...
          p
            ...
            : h
            ? (((i = new MessageChannel()).port1.onmessage = m),
              (g = function () {
          ...
          function I(e, t) {
            if (e === t)
              E(e, TypeError("You cannot resolve a promise with itself"));
            else if (
              ((n = typeof t),
                ...
                (e.prototype._eachEntry = function (e, t) {
                  ...
                  if (r === w) {
                    ...
                    if (o === k && e._state !== C)
                      ...
                      var u = new n(S);
                      a ? E(u, i) : P(u, e, o), this._willSettleAt(u, t);
                    } else
                      this._willSettleAt(
                        new n(function (t) {
                          return t(e);
            ...
            (e = [
              {
                ...
                value: function (e, t) {
                  ...
                  if (e in this.listeners) {
                    ...
                    "function" == typeof r
                      ? r !== t && (this.listeners[e] = [r, t])
                      : 0 > r.indexOf(t) && r.push(t);
                ...
                value: function (e) {
                  ...
                  if (e in this.listeners) {
                    ...
                    if ("function" == typeof a)
                      a.call.apply(a, [this].concat(D(n)));
                    else if (
        ...
        function M() {
          for (var e = arguments.length, t = Array(e), n = 0; n < e; n++)
            t[n] = arguments[n];
          try {
            (window.console.warn || window.console.log).apply(
              this,
              (function (e) {
        ...
        function K(e, t, n, r, o, i, a) {
          ...
          u.done ? t(c) : E.Promise.resolve(c).then(r, o);
        }
        function B(e) {
          return function () {
            var t = this,
                  ...
                  return B(function () {
                    return G(this, function (n) {
                      switch (n.label) {
                        case 0:
                          return (
                            t.emitCall("PageView", e),
                            [
                              4,
                              t.eventTracker.track("PageView", {
                                tag: e || void 0,
                              }),
                            ]
                          );
                ...
                value: function (e) {
                  ...
                  return B(function () {
                    return G(this, function (n) {
                      switch (n.label) {
                        case 0:
                          if ((t.emitCall("Search", e), "object" != typeof e))
                            return [3, 2];
                          return [
                            4,
                            t.eventTracker.track("Search", {
                              tag: e.tag || void 0,
                  ...
                  return B(function () {
                    return G(this, function (n) {
                      switch (n.label) {
                        case 0:
                          return (
                            t.emitCall("ViewCart", e),
                            [
                              4,
                              t.eventTracker.track("ViewCart", {
                                tag: e || void 0,
                              }),
                            ]
                          );
                  ...
                  return B(function () {
                    return G(this, function (n) {
                      switch (n.label) {
                        case 0:
                          if (
                            (t.emitCall("ViewContent", e), "object" != typeof e)
                          )
                            return [3, 2];
                          return [
                            4,
                            t.eventTracker.track("ViewContent", {
                              tag: e.tag || void 0,
                  ...
                  return B(function () {
                    ...
                    return G(this, function (a) {
                      switch (a.label) {
                        case 0:
                          if (
                            (n.emitCall("Purchase", e, t), "object" != typeof e)
                          )
                            return [3, 2];
                          if (((r = H({}, e)), void 0 === r.currency))
                            r.currency = "KRW";
                          else {
                            var u;
                            r.currency &&
                              ((u = r.currency),
                              !(x.indexOf(u.toUpperCase()) > -1)) &&
                              M("Invalid currency: ".concat(r.currency));
                          }
                          if (r.products)
                            for (o = 0; o < r.products.length; ++o)
                              (i = r.products[o]).id &&
                                "string" != typeof i.id &&
                                (i.id = String(i.id));
                          return (
                            (r.tag = t || e.tag || void 0),
                            [4, n.eventTracker.track("Purchase", r)]
                          );
                        case 1:
                        case 3:
                          return a.sent(), [2];
                  ...
                  return B(function () {
                    return G(this, function (n) {
                      switch (n.label) {
                        case 0:
                          return (
                            t.emitCall("CompleteRegistration", e),
                            [
                              4,
                              t.eventTracker.track("CompleteRegistration", {
                                tag: e || void 0,
                              }),
                            ]
                          );
                  ...
                  return B(function () {
                    return G(this, function (n) {
                      switch (n.label) {
                        case 0:
                          return (
                            t.emitCall("Participation", e),
                            [
                              4,
                              t.eventTracker.track("Participation", {
                                tag: e || void 0,
                              }),
                            ]
                          );
                  ...
                  return B(function () {
                    return G(this, function (n) {
                      switch (n.label) {
                        case 0:
                          if (
                            (t.emitCall("AddToCart", e), "object" != typeof e)
                          )
                            return [3, 2];
                          return [
                            4,
                            t.eventTracker.track("AddToCart", {
                              tag: e.tag || void 0,
                              content_id: e.id || void 0,
                            }),
                          ];
                  ...
                  return B(function () {
                    return G(this, function (n) {
                      switch (n.label) {
                        case 0:
                          if (
                            (t.emitCall("AddToWishList", e),
                            "object" != typeof e)
                          )
                            return [3, 2];
                          return [
                            4,
                            t.eventTracker.track("AddToWishList", {
                              tag: e.tag || void 0,
                              content_id: e.id || void 0,
                            }),
                          ];
                  ...
                  return B(function () {
                    return G(this, function (n) {
                      switch (n.label) {
                        case 0:
                          return (
                            t.emitCall("Preparation", e),
                            [
                              4,
                              t.eventTracker.track("Preparation", {
                                tag: e || void 0,
                              }),
                            ]
                          );
                  ...
                  return B(function () {
                    return G(this, function (n) {
                      switch (n.label) {
                        case 0:
                          return (
                            t.emitCall("Tutorial", e),
                            [
                              4,
                              t.eventTracker.track("Tutorial", {
                                tag: e || void 0,
                              }),
                            ]
                          );
                  ...
                  return B(function () {
                    return G(this, function (n) {
                      switch (n.label) {
                        case 0:
                          return (
                            t.emitCall("MissionComplete", e),
                            [
                              4,
                              t.eventTracker.track("MissionComplete", {
                                tag: e || void 0,
                              }),
                            ]
                          );
              ...
              },
              {
                ...
                value: function (e, t, n) {
                  try {
                    ...
                    } else this.emit("eventCall", e, { tag: n || t || void 0 });
                  } catch (e) {}
                },
              },
            ]),
        ...
        function q(e) {
          for (
            ...
            try {
              var i,
                a =
                  ((i = o.split("=").map(decodeURIComponent)),
                  (function (e) {
                ...
                var o = new XMLHttpRequest(),
                  ...
                  c = function () {
                    return {
                      ...
                      url: o.responseURL,
                      text: function () {
                        return E.Promise.resolve(o.responseText);
                      },
                      json: function () {
                        return E.Promise.resolve(o.responseText).then(
                          JSON.parse
                        );
                      },
                      blob: function () {
                        return E.Promise.resolve(new Blob([o.response]));
                      },
                      clone: c,
                      headers: {
                        keys: function () {
                ...
                switch (l.label) {
                  case 0:
                    if (
                      ...
                      return [2, null];
                    (i = r ? { appUserId: r } : { accessToken: o }),
                      (a = n
                        ? "".concat(et, "/appKey/").concat(n)
                        : "".concat(et, "/appId/").concat(t)),
                      (l.label = 1);
                  case 1:
                    return (
                      l.trys.push([1, 4, , 5]),
                      [4, Q(z(a, i), { credentials: "include" })]
                    );
                  case 2:
              ...
              return (function (e, t) {
                ...
                switch (P.label) {
                  case 0:
                    if (
                      ((o = /adfit/i.test(e)),
                      (i = /kakaotalk/i.test(e)),
                      (a = /iphone|ipad/i.test(e)),
                      (u = /android/i.test(e)),
                      (c = /crios/i.test(e)),
                      (s = /daumapps/i.test(e)),
                      (l =
                        /bot|googlebot|crawler|spider|robot|crawling|yeti/i.test(
                          e
                        )),
                      (f =
                        o ||
            ...
            function i(e, t) {
                ...
                var n,
                  ...
                  o = (r =
                    ...
                    ? (((n = {
                        ...
                        n.user +
                        (n.pass ? "&sentry_secret=" + n.pass : "")),
                      n)
                    : "";
                return (
                  (E = y(E, { project: o.projectId })),
                  ((E = y(E, t || {})).maxBreadcrumbs = Math.max(
                    0,
                    Math.min(E.maxBreadcrumbs, 100)
                  )),
                  (T = o.endpoint),
                  (x = E.transport = t.transport || p),
                  this
                );
              }
              function o(e) {
              ...
              function v(e, t, n) {
                ...
                if (
                  ((b = e),
                  C &&
                    (b.stacktrace || C.stacktrace
                      ? d(b.stacktrace, C.stacktrace)
                      : b.exception || C.exception
                      ? ((o = b.exception),
                        (i = C.exception),
                        (a = o),
                        (u = i),
                        !(!!a ^ !!u) &&
                          ...
                          o.type === i.type &&
                            ...
                            (s = i.stacktrace),
                            void 0 !== c || void 0 !== s) &&
                            d(o.stacktrace, i.stacktrace)))
                      : b.fingerprint || C.fingerprint
                      ? !!(b.fingerprint && C.fingerprint) &&
                        h(b.fingerprint) === h(C.fingerprint)
                      : ((v = b.message),
                        (p = C.message),
                        !(!v && !p) && !((v && !p) || (!v && p)) && v === p)))
                )
                  return (
                    l("warn", "Jackdaw dropped repeat event: "),
                    void (t && t(new r("Dropped repeat event")))
                  );
                ((e = y(E, e)).tag = e.tag || {}),
                  (e.extra = e.extra || {}),
                  (e.extra["session:duration"] = m() - w),
                  O &&
                    O.length > 0 &&
                    (e.breadcrumbs = { values: [].slice.call(O, 0) }),
                  (S = e.event_id =
                    "xxxxxxxxxxxx4xxxyxxxxxxxxxxxxxxx".replace(
                      /[xy]/g,
                      function (e) {
                ...
                var o,
                  ...
                  p,
                  b,
                  g = (P = e.exception && e.exception.values[0]);
                k.addBreadcrumb({
                  category: "sentry",
                  message: g
                    ? (g.type ? g.type + ": " : "") + g.value
                    : e.message,
                  event_id: S,
                  level: e.level || "error",
                });
                        ...
                        e.request &&
                          (function (e) {
                            ...
                            if (400 === n || 401 === n || 429 === n) {
                              try {
                                (t = e.getResponseHeader("Retry-After")),
                                  (t = 1e3 * parseInt(t, 10));
                              } catch (e) {}
                              (I = t || 2 * I || 1e3), (A = m());
                            }
              ...
              function d(e, t) {
                ...
                var n = e.frames,
                  r = t.frames;
                if (void 0 === n || void 0 === r || n.length !== r.length)
                  return !1;
              ...
              function h(e) {
                return (
                  ...
                  function e(t) {
                    ...
                    for (r in t)
                      (o = t[r]),
                        (n = void 0 === o ? "undefined" : a(o)),
                        "string" === n
                          ? (o = '"' + o + '"')
                          : "object" === n && null !== o && (o = e(o)),
                        i.push((u ? "" : '"' + r + '":') + String(o));
                    return (u ? "[" : "{") + String(i) + (u ? "]" : "}");
                  }
                )(e);
              ...
              (this.config = n),
                (this.addBreadcrumb = function (e) {
                  var t = y({ timestamp: m() / 1e3 }, e);
                  return (
                    O.push(t),
                    O.length > E.maxBreadcrumbs &&
                      O.splice(0, O.length - E.maxBreadcrumbs),
                    this
                  );
                }),
                ...
                (this.captureException = function (e, t, n) {
                  var i,
                    ...
                    m = x;
                  if (!e)
                    throw new r("Need something to send exception or error");
                  if (
                    (t &&
                      "function" == typeof t.transport &&
                      ((m = t.transport), delete t.transport),
                    e.error && (e = e.error),
                    o(e) ||
                      ((i = e),
                      "[object DOMException]" ===
                              ...
                              (function (e, t, n, r) {
                                ...
                                if (o.url && o.line) {
                                  if (
                                    ...
                                    if (
                                      !e.stack[0].line &&
                                      e.stack[0].func === o.func
                                    )
                                      return (e.stack[0].line = o.line), 0;
                                  }
                  ...
                  return (
                    v(
                      ...
                      O && O.length
                        ...
                        : s &&
                          (d = {
                            frames: [{ filename: s, lineno: l, in_app: !0 }],
                          }),
                      (h = (p = y(
                        {
                          exception: {
                            values: [{ type: a, value: u, stacktrace: d }],
                          },
                        },
                        f
                      )).exception.values[0]),
        ...
        var eE = (function (e) {
          ...
          function o(e, t) {
            ...
            em(this, o),
              (n = r.call(this, e)),
              ew(ey(n), "name", "PixelError"),
              ew(ey(n), "detail", void 0);
            try {
              "function" == typeof Error.captureStackTrace
                ? Error.captureStackTrace(ey(n), n.constructor)
                : n.stack || (n.stack = Error(e).stack);
            } catch (e) {}
            return (n.detail = t), n;
          }
          return (
                      ...
                      switch (a.label) {
                        ...
                        case 1:
                          ...
                          return (
                            ...
                            e.captureException(t, { tags: i, extra: n }),
                            [2]
                          );
                      }
                    });
        ...
        ew(
          ...
          er(function () {
            return eh(
              "https://"
                .concat("974753e2fca1433689ce92827ec28203", "@")
                .concat("aem-kakao-collector.onkakao.net", "/")
                .concat("3307"),
              { release: "v".concat(ef), environment: "release" }
            );
          })
        );
        var ex = (function (e) {
          ...
          function n() {
            ...
            return (
              ...
              ew(ey(e), "name", "PixelRequestError"),
              e
            );
          }
          return n;
        ...
        ((t = n || (n = {})).SUPPORTED = "adfit:3PC:supported"),
          (t.UNSUPPORTED = "adfit:3PC:unsupported"),
          (t.PARTITIONED = "adfit:3PC:partitioned");
        var eL =
            "https://t1.daumcdn.net/kas/static/third-party/cookie/ct2.html",
          eR =
            ((r = {}),
            eD(r, n.SUPPORTED, "Y"),
            eD(r, n.UNSUPPORTED, "N"),
            eD(r, n.PARTITIONED, "P"),
            r),
          eM = (function () {
            var e, t;
            function r() {
              ...
              !(function (e, t) {
                ...
                eD(this, "pendingCheckPromise", void 0),
                eD(this, "resolvePendingCheck", void 0),
                eD(this, "checkTimeoutTimerId", void 0),
                eD(this, "handleMessage", function (t) {
                  var n,
                    o = t.data;
                  r.isThirdPartyCookieSupportStatusMessage(o) &&
                    (null === (n = e.resolvePendingCheck) ||
                      void 0 === n ||
                      n.call(e, eR[o]),
                    e.clearCheck());
                }),
              ...
              (e = [
                {
                  ...
                  value: function (e) {
                    return (
                      this.pendingCheckPromise ||
                        (this.pendingCheckPromise = this.startCheck(e)),
                      this.pendingCheckPromise
                    );
                  },
                },
                  ...
                  value: function (e) {
                    ...
                    return /iP(hone|ad|od)/i.test(window.navigator.userAgent) &&
                      ...
                      : new E.Promise(function (t) {
                          e &&
                            (n.checkTimeoutTimerId = window.setTimeout(
                              n.handleTimeout,
                              e
                            )),
                            window.addEventListener("message", n.handleMessage),
                            (n.resolvePendingCheck = t),
                            r.appendCheckFrame();
                        });
                  },
                },
                {
                  ...
                  value: function () {
                    r.removeCheckFrame(),
                      ...
                      this.checkTimeoutTimerId &&
                        window.clearTimeout(this.checkTimeoutTimerId),
                      (this.checkTimeoutTimerId = void 0),
                      (this.resolvePendingCheck = void 0);
                  },
                },
              ]),
              (t = [
        ...
        var eH = (function () {
          ...
          function n(e, t, r, o) {
            !(function (e, t) {
              ...
              eU(this, "trackId", void 0),
              eU(this, "globalDataStorage", void 0),
              eU(this, "aidStorage", void 0),
              eU(this, "adFitConversionDataService", void 0),
              eU(
                this,
                "thirdPartyCookieSupportStatusChecker",
                eM.getInstance()
              ),
              (this.trackId = e),
              (this.globalDataStorage = t),
              (this.aidStorage = r),
              (this.adFitConversionDataService = o);
          }
          return (
            (e = [
              {
                  ...
                  return eB(function () {
                    ...
                    return eV(this, function (y) {
                      switch (y.label) {
                        ...
                        case 1:
                          if (
                            ((o = (r = y.sent()).isAdFitInAppBrowser),
                            (i = r.isKakaoTalkApp),
                            (a = r.isIOS),
                            r.isBot)
                          )
                        ...
                        case 4:
                          return (
                            (u = y.sent()),
                            (c =
                              window.location.hostname.indexOf(".kakao.com") >
                              -1
                                ? "https://bc.ds.kakao.com/bc"
                                : "https://bc.ad.daum.net/bc"),
                            (s = z(c, { d: JSON.stringify(u) })),
                            (l = n.createHeaders()),
                            [
                              4,
                              (function (e) {
                                ...
                                return new E.Promise(function (t, n) {
                                  ...
                                  r > 0 &&
                                    (i = window.setTimeout(function () {
                                      (i = 0),
                                        n(Error("Fetch request timed out"));
                                    }, r)),
                                    Q(e, { credentials: "include", headers: o })
                                      .then(t)
                                      .catch(n)
                                      .finally(function () {
                                        i > 0 &&
                                          (window.clearTimeout(i), (i = 0));
                                      });
                                });
                              })(s, { headers: l }).catch(function (e) {
                                var t;
                                throw new ex(
                                  ((t = Error),
                                  null != t &&
                        ...
                        case 5:
                          ...
                          return (
                            (v = eE.bind),
                            (d = [void 0, "Fetch response was not ok"]),
                            (p = {
                              statusCode: f.status,
                      ...
                      switch (B.label) {
                        case 0:
                          if (
                            ((l =
                              (!(s =
                                n.globalDataStorage.isLimitAdTrackingEnabled()) &&
                                (null === (r = n.globalDataStorage.getAdId()) ||
                                void 0 === r
                                  ? void 0
                                  : r.trim())) ||
                              void 0),
                            (f =
                              (null ===
                                (o = n.globalDataStorage.getKakaoAccountId()) ||
                              void 0 === o
                                ? void 0
                                : o.trim()) || void 0),
                            !(v = (function () {
                              try {
                                ...
                                if (e) return { appKey: e, accessToken: t };
                              } catch (e) {}
                              return null;
                            })()))
                          )
                        ...
                        case 2:
                          (p =
                            n.globalDataStorage.getEncryptedKakaoAccountId()),
                            (B.label = 3);
                        case 3:
                          return (
                            (d = p || void 0),
                            [
                              4,
                              n.adFitConversionDataService.getAdFitConversionData(),
                            ]
                          );
                        case 4:
                          return (
                            ...
                            (b = h.surl),
                            (m =
                              (null === (i = n.globalDataStorage.getIDFV()) ||
                              void 0 === i
                                ? void 0
                                : i.trim()) || void 0),
                            (g =
                            ...
                            (O =
                              (null ===
                                (c = n.globalDataStorage.getServiceOrigin()) ||
                              void 0 === c
                                ? void 0
                                : c.trim()) || void 0),
                            (S = document.domain),
                            ...
                            (A = b || document.referrer || void 0),
                            (T = window.location !== window.parent.location),
                            (E = window.navigator.doNotTrack ? "Y" : "N"),
                            [4, es()]
                          );
                        case 5:
                          return (
                            (_ = (x = B.sent()).deviceType),
                            (j = x.browser),
                            (D = x.browserVersion),
                            (L = x.os),
                            (R = x.osVersion),
                          ...
                          return (
                            ...
                            [
                              2,
                              {
                                ...
                                site: { identifier: S },
                                sdk: { type: C, version: P, tpc: K },
                                page: { url: I, ref_url: A, is_frame_env: T },
                                device: {
                                  dnt: E,
                                  device_type: _,
                                  is_mobile: N,
              ...
              },
              {
                ...
                value: function () {
                  var e,
                    t = {},
                    r =
                      null === (e = this.aidStorage) || void 0 === e
                        ? void 0
                        : e.get();
                  if (r) {
                    var o = r.aid,
                      ...
                      switch (t.label) {
                        case 0:
                          return (
                            ...
                            [
                              4,
                              e.thirdPartyCookieSupportStatusChecker.getThirdPartyCookieSupportStatus(
                                500
                              ),
                            ]
                          );
        ...
        var eW = (function () {
          ...
          function n(e, t) {
            !(function (e, t) {
              ...
              eG(this, "naverCheckoutObserver", void 0),
              eG(this, "kakaoPixelEventTracker", void 0),
              (this.naverCheckoutObserver = e),
              (this.kakaoPixelEventTracker = t);
          }
          return (
            (e = [
              {
                ...
                value: function (e) {
                  ...
                  this.addListener("buyLinkClick", function () {
                    ...
                    n &&
                      (n.total_price || n.total_quantity) &&
                      t.kakaoPixelEventTracker.purchase(n, "npay_purchase");
                  });
                },
              },
              {
        ...
        var e$ = {
          ...
          ez = (function (e) {
            ...
            function i() {
              ...
              (e = o.call(this)),
              (null === (t = window.nhn) || void 0 === t
                ? void 0
                : t.CheckoutButton) ||
                (null === (n = window.naver) || void 0 === n
                  ? void 0
                  : n.NaverPayButton))
                ? (e.bindClickEvent("buyLink"),
                  e.bindClickEvent("cartLink"),
                  e.bindClickEvent("talkLink"),
                  e.bindClickEvent("wishLink"),
                  e.bindClickEvent("promotionLink"),
                  e)
                : eJ(e);
            }
            return (
        ...
        var e1 = (function () {
          ...
          function n(e, t) {
            !(function (e, t) {
              ...
              e0(this, "paycoCheckoutObserver", void 0),
              e0(this, "kakaoPixelEventTracker", void 0),
              (this.paycoCheckoutObserver = e),
              (this.kakaoPixelEventTracker = t);
          }
          return (
            (e = [
              {
                ...
                value: function (e) {
                  ...
                  this.addListener("checkoutButtonClick", function () {
                    var n;
                    t.kakaoPixelEventTracker.purchase(
                      null !== (n = "function" == typeof e ? e() : e) &&
                        void 0 !== n
                        ? n
                        : {},
                      "payco_purchase"
        ...
        var e5 = {
          ...
          e8 = (function (e) {
            ...
            function i() {
              ...
              (e = o.call(this)),
              void 0 !== window.Payco && "Button" in window.Payco)
                ? (e.bindClickEvent("checkoutButton"),
                  e.bindClickEvent("promotionCheckoutButton"),
                  e)
                : e4(e);
            }
            return (
            ...
            (e = [
              {
                ...
                value: function (e, t, n) {
                  this.storage.setItem(
                    e,
                    JSON.stringify({ value: t, expiry: n })
                  );
                },
              },
              {
        ...
        var to = "KAKAO_PIXEL_AID",
              ...
              (e = [
                {
                  ...
                  value: function (e, t) {
                    ...
                    this.storage.setItem(to, { aid: e, aidTs: t }, n);
                  },
                },
                {
                  key: "get",
                  value: function () {
                    ...
                    return null === e
                      ...
                      : n.isAidItem(e)
                      ? e
                      : (this.storage.removeItem(to), null);
                  },
                },
              ]),
              (t = [
          ...
          ta = "[".concat(
            ev,
            "]: íŠ¸ëž™ IDëŠ” ë¬¸ìžì—´ë¡œ ìž…ë ¥í•´ì•¼ í•©ë‹ˆë‹¤."
          ),
        ...
        var tl = (function () {
          ...
          function n(e) {
            ...
            !(function (e, t) {
              ...
              ts(this, "messageBus", void 0),
              ts(this, "events", {}),
              (this.messageBus = e),
              this.messageBus.addEventListener("message", function (e) {
          ...
          return (
            (e = [
              ...
              },
              {
                ...
                value: function (e) {
                  this.events[e] ||
                    ((this.events[e] = []), this.sendTrackMessage(e));
                },
              },
              {
                key: "addEvent",
              ...
              },
              {
                ...
                value: function (e) {
                  this.messageBus.postMessage(
                    { type: "kakaoPixel:track", trackId: e },
                    "*"
                  );
                },
              },
              {
                ...
                value: function () {
                  var e = { type: "kakaoPixel:events", events: this.events };
              ...
              },
              {
                ...
                value: function (e) {
                  "object" == typeof e &&
                    null !== e &&
                    "type" in e &&
                    "kakaoPixel:requestEvents" === e.type &&
        ...
        var tb = (function () {
          ...
          function n(e, t) {
            !(function (e, t) {
              ...
              tp(this, "adFitConversionDataRepository", void 0),
              tp(this, "etxIdStorage", void 0),
              (this.etxIdStorage = t),
              (this.adFitConversionDataRepository = e);
          }
          return (
            (e = [
              {
                    ...
                    return ty(this, function (n) {
                      switch (n.label) {
                        case 0:
                          return [
                            4,
                            e.adFitConversionDataRepository.getAdFitConversionData(),
                          ];
                        case 1:
                          if (!(t = n.sent().etxId)) return [2];
                          return e.etxIdStorage.set(t), [2];
                      }
                    });
                  })();
                },
                  ...
                  return tv(function () {
                    ...
                    return ty(this, function (n) {
                      switch (n.label) {
                        case 0:
                          return (
                            (t = [{ etxId: e.etxIdStorage.get() || void 0 }]),
                            [
                              4,
                              e.adFitConversionDataRepository.getAdFitConversionData(),
                            ]
          ...
          tw = (function () {
            ...
            function t() {
              ...
              !(function (e, t) {
                ...
                (e = "getAdFitConversionData"),
                (n = er(t.getAdFitConversionData)),
                e in this
                  ? Object.defineProperty(this, e, {
                      value: n,
                      enumerable: !0,
              ...
              (e = [
                {
                  ...
                  value: function () {
                    if (tk in window) {
                      var e = window[tk];
                      if ("string" == typeof e) return { etxId: e };
                    }
                  },
                },
                {
                  ...
                  value: function () {
                    ...
                    if (Object.keys(e).length > 0)
                      return { etxId: e.etxId, surl: e.surl };
                  },
                },
                {
                        ...
                        switch (n.label) {
                          case 0:
                            if (
                              (n.trys.push([0, 3, , 4]),
                              (e =
                                t.getAndroidKakaoTalkInAppBrowserConversionData() ||
                                t.getAdFitConversionDataFromReferrer()))
                            )
                              return [3, 2];
            ...
            try {
              ...
              return {
                module:
                  ...
                  (s = new tl(window)),
                  (l = new tw()),
                  (f = new tb(l, u)).storeEtxId(),
                  ((v = function (n) {
                    try {
                      if ("number" == typeof n) M(ta);
                      else if ("string" != typeof n || !(n.trim().length > 0))
                        throw new eE(tu);
                      if (n in r) return r[n];
                      e || (e = new ez()), t || (t = new e8());
                      var i = new eH(String(n), o, c, f),
                        a = new W(i),
                        u = new eW(e, a),
                        l = new e1(t, a),
                        v = new m({
                          ...
                          paycoCheckoutEventTracker: l,
                        });
                      return (
                        (r[n] = v),
                        s.addTrack(n),
                        a.addListener("eventCall", function (e, t) {
                          s.addEventCall({
                            eventCode: e,
                            trackId: n,
                            parameters: t,
                      ...
                      throw (eE.capture(e, { trackId: n }), e);
                    }
                  }).setKakaoAccountId = function (e) {
                    return o.setKakaoAccountId(e), v;
                  }),
                  (v.getKakaoAccountId = function () {
                    return o.getKakaoAccountId();
                  }),
                  (v.setEncryptedKakaoAccountId = function (e) {
                    return o.setEncryptedKakaoAccountId(e), v;
                  }),
                  (v.getEncryptedKakaoAccountId = function () {
                    return o.getEncryptedKakaoAccountId();
                  }),
                  (v.setIDFV = function (e) {
                    return o.setIDFV(e), v;
                  }),
                  (v.getIDFV = function () {
                    return o.getIDFV();
                  }),
                  (v.setServiceOrigin = function (e) {
                    return o.setServiceOrigin(e), v;
                  }),
                  (v.getServiceOrigin = function () {
                    return o.getServiceOrigin();
                  }),
                  (v.hasServiceOrigin = function () {
                    return o.hasServiceOrigin();
                  }),
                  (v.setAdId = function (e) {
                    return o.setAdId(e), v;
                  }),
                  (v.getAdId = function () {
                    return o.getAdId();
                  }),
                  (v.setLimitAdTrackingEnabled = function (e) {
                    return o.setLimitAdTrackingEnabled(e), v;
                  }),
                  (v.isLimitAdTrackingEnabled = function () {
