  ...
  var t = {
      ...
      841: function (t, n, r) {
        ...
        t.exports = function (t) {
          ...
          var g,
            ...
            j = 0;
          if (!O || (this === v && c(O)))
            for (g = f(n), x = r ? new this(g) : v(g); g > j; j++)
              (S = d ? y(n[j], j) : n[j]), s(x, j, S);
          else
            for (
              w = (b = p(n, O)).next, x = r ? new this() : [];
              !(m = o(w, b)).done;
              j++
            )
              (S = d ? u(b, y, [m.value, j], !0) : m.value), s(x, j, S);
          return (x.length = j), x;
        };
      },
      8180: function (t, n, r) {
      ...
      3085: function (t, n, r) {
        ...
        t.exports = function (t, n) {
          ...
          for (y in n)
            (o =
              !(r = a(S ? y : w + (O ? "." : "#") + y, t.forced)) &&
              A &&
              l(A, y)),
              (g = P[y]),
              o && (x = t.dontCallGetSet ? (b = c(A, y)) && b.value : A[y]),
              (d = o && x ? x : n[y]),
              (o && typeof g == typeof d) ||
                ((m =
                  t.bind && o
                    ...
                    ? i(d)
                    : d),
                (t.sham || (d && d.sham) || (g && g.sham)) && p(m, "sham", !0),
                p(P, y, m),
                j &&
                  (l(f, (h = w + "Prototype")) || p(f, h, {}),
                  p(f[h], y, d),
                  t.real && L && (r || !L[y]) && p(L, y, d)));
        };
      },
      6192: function (t) {
        t.exports = function (t) {
      ...
      5297: function (t, n, r) {
        ...
        t.exports = function (t, n, r, u, h, d, P) {
          ...
          if (
            (U &&
              (L = f(U.call(new t()))) !== Object.prototype &&
              L.next &&
              (i || f(L) === m || (s ? s(L, m) : c(L[w]) || v(L, w, A)),
              p(L, k, !0, !0),
              i && (y[k] = A)),
            g &&
              h == O &&
            ...
            if (((T = { values: R(O), keys: d ? M : R(S), entries: R(j) }), P))
              for (E in T) (b || I || !(E in C)) && v(C, E, T[E]);
            else e({ target: n, proto: !0, forced: b || I }, T);
          return (
            (i && !P) || C[w] === M || v(C, w, M, { name: h }), (y[n] = M), T
          );
        };
      },
      4413: function (t, n, r) {
      ...
      1284: function (t, n, r) {
        ...
        t.exports = function (t, n, r, f) {
          if (t) {
            ...
            u(s, a) || o(s, a, { configurable: !0, value: n }),
              f && !e && i(s, "toString", c);
          }
        };
      },
      ...
      8118: function (t, n, r) {
        r(3085)({ target: "Array", stat: !0 }, { isArray: r(4770) });
      },
      8939: function (t, n, r) {
        "use strict";
        var e = r(101),
        ...
        if (
          (o("keys"), o("values"), o("entries"), !s && p && "values" !== y.name)
        )
          try {
          ...
          { target: "Array", proto: !0, forced: !h },
          {
            slice: function (t, n) {
              ...
              if (
                ...
                return v(l, x, m);
              for (
                e = new (void 0 === r ? d : r)(g(m - x, 0)), p = 0;
                x < m;
                x++, p++
              )
                x in l && s(e, p, l[x]);
      ...
      9704: function (t, n, r) {
        var e = r(3085),
          ...
          L = function (t, n, r) {
            var e = g(r, n - 1),
              o = g(r, n + 1);
            return (d(S, t) && !d(O, o)) || (d(O, t) && !d(S, e))
              ? "\\u" + b(x(t, 0), 16)
              : t;
          };
        y &&
        ...
        o(
          {
            ...
            forced:
              !!(
                l ||
                d ||
                ((e = u(String.prototype, "endsWith")), !e || e.writable)
              ) && !d,
          },
          {
            endsWith: function (t) {
      ...
      9351: function (t, n, r) {
        ...
        var e = r(3085),
          ...
          it = function (t, n) {
            var r = (tt[t] = x(q));
            return (
              W(r, { type: G, tag: t, description: n }),
              a || (r.description = n),
              r
            );
          },
          ...
          at = function (t) {
            var n = y(t),
              r = i(K, this, n);
            return (
              !(this === B && p(tt, n) && !p(nt, n)) &&
              (!(r || !p(this, n) || !p(tt, n) || (p(this, N) && this[N][n])) ||
                r)
            );
          },
          ft = function (t, n) {
            ...
            if (r !== B || !p(tt, e) || p(nt, e)) {
              var o = $(r, e);
              return (
                !o || !p(tt, e) || (p(r, N) && r[N][e]) || (o.enumerable = !0),
                o
              );
            }
          },
        ...
        f ||
          ((V = function () {
            ...
            var t =
              ...
              r = function (t) {
                this === B && i(r, nt, t),
                  p(this, N) && p(this[N], n) && (this[N][n] = !1),
                  ot(this, n, g(1, t));
              };
            return a && et && ot(B, n, { configurable: !0, set: r }), it(n, t);
          }),
          ...
          a &&
            ...
            c || L(B, "propertyIsEnumerable", at, { unsafe: !0 }))),
          e(
      ...
      7054: function (t, n, r) {
        ...
        var e = r(3085),
          ...
          ft = l(
            function (t, n) {
              I(this, { type: k, iterator: j(C(t).entries), kind: n });
            },
            "Iterator",
            function () {
              var t = F(this),
          ...
          parseObject: function (t) {
            ...
            if (f)
              for (r = (n = j(t, f)).next; !(e = i(r, n)).done; ) {
                if (
                  ((u = (o = j(m(e.value))).next),
                  (c = i(u, o)).done || (a = i(u, o)).done || !i(u, o).done)
                )
                  throw H("Expected sequence with length 2");
                Q(this.entries, { key: w(c.value), value: w(a.value) });
              }
            else
              for (var s in t)
                d(t, s) && Q(this.entries, { key: s, value: w(t[s]) });
          },
          parseQuery: function (t) {
            if (t)
              for (var n, r, e = K(t, "&"), o = 0; o < e.length; )
                (n = e[o++]).length &&
                  ((r = K(n, "=")),
                  Q(this.entries, { key: ot(X(r)), value: ot(J(r, "=")) }));
          },
          serialize: function () {
            for (var t, n = this.entries, r = [], e = 0; e < n.length; )
              (t = n[e++]), Q(r, at(t.key) + "=" + at(t.value));
            return J(r, "&");
          },
          update: function () {
        ...
        if (
          (s(
            lt,
            {
              append: function (t, n) {
                ...
                var r = C(this);
                Q(r.entries, { key: w(t), value: w(n) }), r.updateURL();
              },
              delete: function (t) {
                P(arguments.length, 1);
                for (
                  var n = C(this), r = n.entries, e = w(t), o = 0;
                  o < r.length;
              ...
              get: function (t) {
                P(arguments.length, 1);
                for (
                  var n = C(this).entries, r = w(t), e = 0;
                  e < n.length;
                  e++
                )
              ...
              getAll: function (t) {
                P(arguments.length, 1);
                for (
                  var n = C(this).entries, r = w(t), e = [], o = 0;
                  o < n.length;
                  o++
                )
                  n[o].key === r && Q(e, n[o].value);
                return e;
              },
              has: function (t) {
                P(arguments.length, 1);
              ...
              set: function (t, n) {
                ...
                for (
                  ...
                  (r = o[a]).key === u &&
                    (i ? Y(o, a--, 1) : ((i = !0), (r.value = c)));
                i || Q(o, { key: u, value: c }), e.updateURL();
              },
              sort: function () {
                var t = C(this);
              ...
              forEach: function (t) {
                for (
                  var n,
                    r = C(this).entries,
                    e = g(t, arguments.length > 1 ? arguments[1] : void 0),
                    o = 0;
                  o < r.length;
          ...
          f(lt, E, lt.entries, { name: "entries" }),
          f(
            lt,
            "toString",
            function () {
          ...
          var vt = u(z.has),
            ...
            yt = function (t) {
              if (b(t)) {
                ...
                if (x(r) === R)
                  return (
                    (n = t.headers ? new N(t.headers) : new N()),
                    vt(n, "content-type") ||
                      ht(
                        n,
                        "content-type",
                    ...
                    S(t, { body: O(0, w(r)), headers: O(0, n) })
                  );
              }
              return t;
            };
    ...
    (function () {
      ...
      function v(t, n) {
        return (
          ...
          (function (t, n) {
            var r =
              null == t ? null : (void 0 !== c && a(t)) || t["@@iterator"];
            if (null != r) {
              var e,
                o,
                i,
        ...
        if (!r) {
          if (
            ...
            (r = (function (t, n) {
              ...
              if (!t) return;
              if ("string" == typeof t) return L(t, n);
              var e = m()((r = Object.prototype.toString.call(t))).call(
                r,
                8,
                -1
              );
      ...
      function E() {
        var t;
        return (
          "naver.com" === window.location.hostname ||
          !!y()((t = window.location.hostname)).call(t, ".naver.com")
        );
      }
      function R(t) {
        var n,
          r = P(document.cookie.split("; "));
        try {
          for (r.s(); !(n = r.n()).done; ) {
            ...
            var n,
              r = (function (t) {
                try {
                  var n;
                  if (g())
                    return null !== (n = new (g())(location.search).get(t)) &&
                      void 0 !== n
                      ? n
                      : void 0;
                  var r,
                    e = P(location.search.split("?")[1].split("&"));
                  try {
                    for (e.s(); !(r = e.n()).done; ) {
      ...
      function I() {
        ...
        if (!r || "1" !== e) {
          var o,
            u = "".concat("https://nam.veta.naver.com", "/nac/1");
          if (r) u = i()((o = "".concat(u, "/"))).call(o, r);
          T({ url: u, withCredentials: !0 }, function () {
            var r;
            (document.cookie = i()((r = "".concat(n, "=1; max-age="))).call(
              r,
              86400,
              "; domain=.naver.com"
            )),
      ...
      if (!window.namSynchronizer)
        try {
          window.namSynchronizer =
            (E()
              ? I()
              : (function () {
                  try {
