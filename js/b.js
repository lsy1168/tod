                          ...
                          if (!p()(c, g)) {
                            ...
                            if (g.hasAttribute("typeof")) {
                              ...
                              (s[w] = k),
                                ...
                                e.push({ element: g, workingNode: k });
                              break;
                            }
                            s[w] = i(g);
                          }
        ...
        (function () {
          ...
          function C() {
            var a =
              ...
              d = arguments[2],
              e = c;
            e === null && ((e = n(a, d)), e === null && (e = n(b.referrer, d)));
          ...
          (function () {
            ...
            e.exports = new d(function (d, e) {
              ...
              try {
                var s = q(p);
                s != null &&
                  (new Date().getTime() - Number(s)) / (1e3 * 60 * 60 * 24) >
                    90 &&
                  (r(p), r(o));
                s = !1;
                r = "";
...
fbq.registerPlugin("253845987064015", {
  __fbEventsPlugin: 1,
  plugin: function (fbq, instance, config) {
    config.set("253845987064015", "inferredEvents", {
      buttonSelector: null,
      disableRestrictedData: false,
    });
    fbq.loadPlugin("inferredevents");
    fbq.loadPlugin("identity");
    instance.optIn("253845987064015", "InferredEvents", true);
    config.set("253845987064015", "automaticMatching", {
      selectedMatchKeys: ["fn", "ln", "ge", "ph", "country"],
    });
    fbq.loadPlugin("inferredevents");
    fbq.loadPlugin("identity");
    instance.optIn("253845987064015", "AutomaticMatching", true);
    fbq.loadPlugin("iwlbootstrapper");
    instance.optIn("253845987064015", "IWLBootstrapper", true);
    config.set("253845987064015", "cookie", {
      fbcParamsConfig: {
        params: [
    ...
    instance.optIn("253845987064015", "FirstPartyCookies", true);
    fbq.loadPlugin("inferredevents");
    instance.optIn("253845987064015", "InferredEvents", true);
    ...
    config.set("253845987064015", "prohibitedSources", {
      prohibitedSources: [],
    });
    fbq.loadPlugin("prohibitedsources");
    instance.optIn("253845987064015", "ProhibitedSources", true);
    config.set("253845987064015", "unwantedData", {
      blacklisted_keys: {},
      sensitive_keys: {},
    });
    fbq.loadPlugin("unwanteddata");
    instance.optIn("253845987064015", "UnwantedData", true);
    config.set("253845987064015", "IABPCMAEBridge", {
      enableAutoEventId: true,
    });
    fbq.loadPlugin("iabpcmaebridge");
    instance.optIn("253845987064015", "IABPCMAEBridge", true);
    config.set("253845987064015", "browserProperties", {
      delayInMs: 200,
    ...
    instance.optIn("253845987064015", "BrowserProperties", true);
    config.set("253845987064015", "clientHint", {
      delayInMs: 200,
      disableBackupTimeout: false,
    });
    fbq.loadPlugin("clienthint");
    instance.optIn("253845987064015", "ClientHint", true);
    fbq.loadPlugin("lastexternalreferrer");
    instance.optIn("253845987064015", "LastExternalReferrer", true);
    fbq.loadPlugin("cookiedeprecationlabel");
    instance.optIn("253845987064015", "CookieDeprecationLabel", true);
    fbq.loadPlugin("unwantedparams");
    instance.optIn("253845987064015", "UnwantedParams", true);
    fbq.loadPlugin("standardparamchecks");
    instance.optIn("253845987064015", "StandardParamChecks", true);
    instance.configLoaded("253845987064015");
  },
});
